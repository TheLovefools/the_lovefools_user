        ...
        <div style={{ background: '#D4BA97', minHeight: '100vh', paddingTop: '12vh' }}>
            <div className='tc-section common-section'>
                <div className="tc-inner-card">
                    <h2 className='text-center common-heading-h2'><small>Terms and Conditions for Table Reservations at LoveFools</small></h2>
                    <p className="p18 text-center" style={{ fontSize: "18px" }}>Welcome to LoveFools! By making a reservation on our website, you agree to the following terms and
