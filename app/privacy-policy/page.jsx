    ...
    return (
        <div style={{ background: '#D4BA97', minHeight: '100vh', paddingTop: '12vh' }}>
            <div style={{ padding: 15 }}>
                <h2 className='text-center' style={{ fontSize: 'large', fontWeight: 600 }}>Privacy Policy for Table Reservations at LoveFools</h2>
                <p class="p18 text-center">Welcome to LoveFools! By making a reservation on our website, you agree to the following Privacy Policy regarding booking and cancellations.</p>
                <br />
